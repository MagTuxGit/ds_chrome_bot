...
var showInfo = function () { \
	...
	botDiv.innerHTML = ' \\ \
		<span style=\\'font-size: 30px; text-align:left;\\'>totalBps = '+NumUtils.byteConvert(totalBps, 2)+'</span><br> \\ \
		<span style=\\'font-size: 30px; text-align:left;\\'>nextBuyObject = '+nextBuyObject.name+'</span><br> \\ \
		<span style=\\'font-size: 30px; text-align:left;\\'>nextBuyPrice = '+NumUtils.byteConvert(nextBuyPrice,2)+'</span><br> \\ \
...
var runLoop = function () { \
	...
	if (nextBuyTime==999999999) { \
		...
		cursorLvl = localStats.powerUps[0].purchasedUpgrades.length; \
		clicksQuot = clicksPs*cursorLvl/10+1; \
		getNextBuy(); \
	}; \
